(function e(t, r) {
    ...
    , function(e, t, r) {
        ...
        e.exports = function e(t) {
            ...
            var g, m, y, b;
            if (d)
                h = n(h, f > 2 ? arguments[2] : undefined, 2);
            ...
            while (i <= f.length) {
                ...
                case se:
                    if (d && (T.test(d) || d == "+" || d == "-" || d == ".")) {
                        ...
                        if (r && (Z(e) != c(J, o) || o == "file" && ($(e) || e.port !== null) || e.scheme == "file" && !e.host))
                            return;
                        e.scheme = o;
                        if (r) {
                            if (Z(e) && J[e.scheme] == e.port)
                                e.port = null;
                            return
                        }
                        o = "";
            ...
            if (t !== undefined) {
                if (v(t)) {
                    ...
                    if (typeof a === "function") {
                        ...
                        while (!(o = i.next()).done) {
                            s = p(d(o.value));
                            if ((u = s.next()).done || (l = s.next()).done || !s.next().done)
    ...
    , function(e, t, r) {
        ...
        e.exports = function(e, t, r) {
            var i, o;
            if (a && typeof (i = t.constructor) == "function" && i !== r && n(o = i.prototype) && o !== r.prototype)
                a(e, o);
            return e
        }
    }
    ...
    , function(e, t, r) {
        ...
        Object.defineProperty(H, "return", {
            enumerable: false
        });
        function X(e, t) {
            if (t === void 0) {
    ...
    , function(e, t, r) {
        ...
        function U(e) {
            ...
            (0,
            a.setVerbosityLevel)(n.verbosity);
            if (!u) {
                var p = {
        ...
        var B = function e() {
            ...
            var r = function() {
                ...
                R(e, [{
                    ...
                    value: function e(t, r) {
                        (0,
                        i.deprecated)("PDFDocumentLoadingTask.then method, " + "use the `promise` getter instead.");
            ...
            R(e, [{
                ...
                value: function e() {
                    ...
                    if (arguments.length > 1 || typeof arguments[0] === "number") {
                        (0,
                        i.deprecated)("getViewport is called with obsolete arguments.");
                        r = arguments[0];
                ...
                value: function e(t) {
                    var r = this;
                    (0,
                    a.assert)(t.intent, 'PDFPageProxy._pumpOperatorList: Expected "intent" argument.');
                ...
                value: function e(t) {
                    ...
                    var n = t.intentState
                      ...
                      , u = s === void 0 ? false : s;
                    (0,
                    a.assert)(o instanceof Error, 'PDFPageProxy._abortOperatorList: Expected "reason" argument.');
                    if (!n.streamReader) {
                        return
                    }
                    if (!u) {
                ...
                R(e, [{
                    ...
                    value: function e() {
                        ...
                        if (typeof Worker !== "undefined" && !L && !s()) {
                            ...
                            try {
                                if (!(0,
                                a.isSameOrigin)(window.location.href, r)) {
                    ...
                    r.on("commonobj", function(e) {
                        ...
                        case "Font":
                            ...
                            if ("error"in u) {
                                var f = u.error;
                                (0,
                                a.warn)("Error during font loading: ".concat(f));
                            ...
                            t.fontLoader.bind(d).then(function() {
                                ...
                                r.sendWithPromise("FontFallback", {
                                    id: i
                                })["finally"](function() {
                                    t.commonObjs.resolve(i, d)
                                })
        ...
        var K = function() {
            ...
            R(e, [{
                ...
                value: function e(t, r) {
                    (0,
                    i.deprecated)("RenderTask.then method, use the `promise` getter instead.");
                    return this.promise.then.apply(this.promise, arguments)
                }
            }, {
                key: "promise",
    ...
    , function(e, t, r) {
                                        ...
                                        n.onreadystatechange = function() {
                                            ...
                                            if (n.status === 200 || n.status === 0) {
                                                ...
                                                if (r.isCompressed && n.response) {
                                                    ...
                                                    i = (0,
                                                    a.stringToBytes)(n.responseText)
                                                }
                                                if (i) {
                                                    e({
                                                        cMapData: i,
        ...
        var A = function() {
            ...
            g(e, [{
                ...
                value: function e(t, r) {
                    (0,
                    a.assert)(t > 0 && r > 0, "Invalid SVG dimensions");
                ...
                value: function e(t) {
                    (0,
                    a.assert)(typeof t === "string", "Invalid SVG element type");
        ...
        function C(e) {
            var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}
              ...
              , s = o === void 0 ? true : o;
            (0,
            a.assert)(r && typeof r === "string", 'addLinkAttributes: A valid "url" parameter must provided.');
            var u = (0,
            ...
            g(e, [{
                ...
                value: function e(t) {
                    ...
                    if (t in this.started) {
                        (0,
                        a.warn)("Timer is already running for " + t)
                    }
                ...
                value: function e(t) {
                    ...
                    if (!(t in this.started)) {
                        (0,
                        a.warn)("Timer has not been started for " + t)
                    }
                    this.times.push({
                        name: t,
        ...
        var E = function() {
            function e() {
                v(this, e);
                (0,
                a.unreachable)("Cannot initialize DummyStatTimer.")
            }
            g(e, null, [{
                key: "time",
                value: function e(t) {}
        ...
        function I(e) {
            (0,
            a.assert)(e instanceof Image, "Invalid `img` parameter.");
            var t = e.src;
    ...
    , function(e, t, r) {
        ...
        var m = function() {
            ...
            g(e, [{
                        ...
                        return n["default"].wrap(function e(n) {
                            while (1) {
                                ...
                                case 12:
                                    ...
                                    (0,
                                    a.warn)("Failed to load font '".concat(i.family, "': '").concat(n.t0, "'."));
                ...
                get: function e() {
                    (0,
                    a.unreachable)("Abstract method `isFontLoadingAPISupported`.")
                }
            }, {
            ...
            t.FontLoader = y = function(e) {
                ...
                g(t, [{
                    ...
                    value: function e(t) {
                        function r() {
                            (0,
                            a.assert)(!i.done, "completeRequest() cannot be called twice.");
                            i.done = true;
                    ...
                    get: function e() {
                        ...
                        return (0,
                        a.shadow)(this, "isFontLoadingAPISupported", t)
                    }
                }, {
                    key: "isSyncFontLoadingSupported",
                    get: function e() {
                        ...
                        return (0,
                        a.shadow)(this, "isSyncFontLoadingSupported", t)
                    }
                }, {
                    key: "_loadTestFont",
                    get: function e() {
        ...
        var _ = function() {
            ...
            g(e, [{
                ...
                value: function e() {
                    ...
                    var t = (0,
                    a.bytesToString)(new Uint8Array(this.data));
                ...
                value: function e(t, r) {
                    ...
                    try {
                        ...
                        (0,
                        a.warn)('getPathGenerator - ignoring character: "'.concat(e, '".'));
        ...
        var m = function e() {
            ...
            m.prototype = {
                ...
                get isFontSubpixelAAEnabled() {
                    ...
                    return (0,
                    n.shadow)(this, "isFontSubpixelAAEnabled", a)
                },
                ...
                showType3Text: function e(t) {
                    ...
                    for (p = 0; p < d; ++p) {
                        ...
                        if (!_) {
                            (0,
                            n.warn)('Type3 character "'.concat(g.operatorListId, '" is not available.'));
                            continue
                        }
    ...
    , function(e, t, r) {
        ...
        s.prototype = {
            ...
            _processStreamMessage: function e(t) {
                ...
                case i.ENQUEUE:
                    (0,
                    n.assert)(this.streamControllers[u], "enqueue should have stream controller");
                ...
                case i.CLOSE:
                    (0,
                    n.assert)(this.streamControllers[u], "close should have stream controller");
                    if (this.streamControllers[u].isClosed) {
                        break
                    }
                ...
                case i.ERROR:
                    (0,
                    n.assert)(this.streamControllers[u], "error should have stream controller");
    ...
    , function(e, t, r) {
        ...
        var u = function() {
            function e(t) {
                i(this, e);
                (0,
                n.assert)(typeof t === "string", "Metadata: input is not a string");
                t = this._repair(t);
    ...
    , function(e, t, r) {
        ...
        var m = function() {
            ...
            p(e, [{
                ...
                value: function e() {
                    (0,
                    a.unreachable)("Abstract method `AnnotationElement.render` called")
                }
            }]);
            return e
        }();
        ...
        t.SVGGraphics = y;
        {
            ...
            var P = function() {
                ...
                function d(r, a, i, o) {
                    ...
                    return (0,
                    n.createObjectURL)(k, "image/png", i)
                }
            ...
            t.SVGGraphics = y = function() {
                ...
                m(e, [{
                    ...
                    value: function e(t) {
                        ...
                        try {
                            for (var o = t[Symbol.iterator](), s; !(r = (s = o.next()).done); r = true) {
                                ...
                                default:
                                    (0,
                                    n.warn)("Unimplemented operator ".concat(l));
                                    break
                                }
                            }
                        } catch (e) {
                    ...
                    value: function e(t) {
                        ...
                        try {
                            for (var o = t[Symbol.iterator](), s; !(r = (s = o.next()).done); r = true) {
                                ...
                                default:
                                    (0,
                                    n.warn)("Unimplemented graphic state operator ".concat(l));
                                    break
                                }
                            }
                        } catch (e) {
                    ...
                    value: function e(t) {
                        ...
                        if (!r) {
                            (0,
                            n.warn)("Dependent image with object ID ".concat(t, " is not ready yet"));
                            return
                        }
                        this.paintInlineImageXObject(r)
                    }
    ...
    , function(e, t, r) {
        ...
        var O = function(e) {
            ...
            function t(e, r, n) {
                ...
                a._setReadableStream(y.createReadStream(i, {
                    start: r,
                    end: n - 1
                }));
                return a
    ...
    , function(e, t, r) {
        ...
        function i(e) {
            var t = e.getResponseHeader
              ...
              , i = e.disableRange;
            (0,
            n.assert)(a > 0, "Range chunk size must be larger than zero");
            var o = {
        ...
        function o(e) {
            ...
            if (t) {
                var r = (0,
                a.getFilenameFromContentDispositionHeader)(t);
                if (r.includes("%")) {
                    try {
        ...
        var m = function() {
            ...
            f(e, [{
                ...
                value: function e(t) {
                    var r = this._url;
                    var n = (0,
                    i.createResponseStatusError)(t, r);
                    this._storedError = n;
            ...
            function e(t) {
                ...
                fetch(u, h(this._headers, this._withCredentials, this._abortController)).then(function(e) {
                    ...
                    i.validateResponseStatus)(e.status)) {
                        throw (0,
                        i.createResponseStatusError)(e.status, u)
                    }
        ...
        var p = function() {
            function e(t, r, n) {
                ...
                fetch(f, h(this._headers, this._withCredentials, this._abortController)).then(function(e) {
                    ...
                    i.validateResponseStatus)(e.status)) {
                        throw (0,
                        i.createResponseStatusError)(e.status, f)
                    }

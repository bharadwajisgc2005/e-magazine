...
, function(module, exports, __webpack_require__) {
    ...
    var BaseMathUtils = function() {
        ...
        BaseMathUtils.interpolateLinear = function(x, y, xi) {
            return x[0] > x[1] && (x = x.reverse(),
            y = y.reverse()),
            xi < x[0] ? y[0] : xi > x[1] ? y[1] : BaseMathUtils.extrapolateLinear(x, y, xi)
        }
        ,
        ...
        BaseMathUtils.mapl2L = function(ls, len, n, f) {
            for (var dL = len / (n - 1), L = 0, i = 0, d = ls[0]; i < ls.length - 1 && L < len + .1 * dL; ++i,
            d += ls[i])
                Math.abs(L - d) < Math.abs(L - d - ls[i + 1]) && (f(i, L),
                L += dL);
        ...
        BaseMathUtils.computeInterpCoefs = function(tri, p) {
            for (var s = BaseMathUtils.computeSquare(tri), coefs = [], l = tri.length, i = 0; i < l; ++i)
    ...
    var _libs = __webpack_require__(0)
      ...
      , MathUtils = function(_BaseMathUtils) {
        ...
        MathUtils.getLinearIndeces = function(spline, n) {
            ...
            ls.push(1e7);
            for (var res = [], dl = l / (n - 1), _i = 0, L = 0, _d = ls[0]; _i < ls.length - 1; ++_i,
            _d += ls[_i])
                Math.abs(L - _d) < Math.abs(L - _d - ls[_i + 1]) && (res.push(2e-4 * _i),
                L += dl);
            return res
        }
        ,
    ...
    var _GraphUtils = __webpack_require__(4)
      ...
      , ImageBase = function() {
        ...
        ImageBase.prototype.pushCtx = function() {
            return Math.abs(this.resW - this.c.width) >= 1 && (this.c.width = this.resW),
            Math.abs(this.resH - this.c.height) >= 1 && (this.c.height = this.resH),
            this.ctx.save(),
    ...
    var _extends = Object.assign || function(target) {
      ...
      , EventConverter = function() {
        ...
        return EventConverter.prototype.setEnable = function(vl) {
            vl || (this.mCapObject && (this.notify(this.mCapObject, _libs.$.Event("mouseup"), "mouseup"),
            this.mCapObject = void 0),
            this.mHovObject && (this.notify(this.mHovObject, _libs.$.Event("mouseout"), "mouseout"),
        ...
        EventConverter.prototype.convertTouch = function(e, data, object) {
            ...
            case "touchstart":
                ...
                break;
            case "touchend":
                this.tCapObject && !this.test(this.tCapObject, object) ? (this.notify(this.tCapObject, e, "touchend"),
                notify = !1) : object && this.test(this.tCapObject, object) && this.notify(object, e, "touchtap"),
        ...
        EventConverter.prototype.convertMouse = function(e, data, object) {
            ...
            case "mousedown":
                ...
                break;
            case "mouseup":
                this.mCapObject && !this.test(this.mCapObject, object) && (this.notify(this.mCapObject, e, "mouseup"),
                notify = !1);
                break;
            case "click":
            ...
            case "mouseover":
            case "mousemove":
                !this.test(this.mHovObject, object) && this.mHovObject && (this.notify(this.mHovObject, e, "mouseout"),
                this.mHovObject = void 0),
                !this.mHovObject && object && (this.notify(object, e, "mouseover"),
                this.mHovObject = object),
                notify = "mousemove" === e.type;
                break;
            case "mouseleave":
            case "mouseout":
                this.mHovObject && (this.notify(this.mHovObject, e, "mouseout"),
                this.mHovObject = void 0),
                notify = !1
            }
            return notify
      ...
      , SheetBlock = function() {
        ...
        SheetBlock.prototype.set = function(angle) {
            ...
            var closedAngle = void 0
              , binderTurn = void 0;
            "object" === (void 0 === angle ? "undefined" : _typeof(angle)) ? (this.angle = angle.openedAngle,
            closedAngle = angle.closedAngle,
            binderTurn = angle.binderTurn > PI / 2 ? PI - angle.binderTurn : angle.binderTurn) : this.angle = angle,
            this.corner.height = height,
            this.p.first === first && this.p.last === last || (this.sideTexture.repeat.set(0, last - first),
            this.sideTexture.needsUpdate = !0,
            ...
            this.angle <= PI / 2 ? (hl = (props.sheets - first) * props.depth,
            hr = (props.sheets - last) * props.depth) : (hl = first * props.depth,
            hr = last * props.depth);
            ...
            this.angle > PI / 2 && (this.inverse(left),
            this.inverse(right),
            offset = -offset),
        ...
        SheetBlock.prototype.setPoints = function(left, right, offset) {
            for (var _this2 = this, p = this.getProps(), i = 0, ys = [right, left], y = 0; y < _sheetBlock2.default.resY; ++y)
                for (var z = 0; z < _sheetBlock2.default.resZ; ++z)
                    for (var x = 0; x < _sheetBlock2.default.resX; ++x)
                        this.geometry.vertices[i++].set(ys[y].x[x] * p.width + offset, ys[y].y[x] * p.width, z * p.height / (_sheetBlock2.default.resZ - 1) - .5 * p.height);
            if (i !== this.geometry.vertices.length && console.warn("setPoints: bad mapping!"),
            this.corner.use && !this.corner.points.length) {
                ...
                for (var _i7 = 0, l = this.geometry.vertices.length; _i7 < l; ++_i7)
                    if (plane.projectPoint(this.geometry.vertices[_i7], proj),
            ...
            if (this.corner.use && Math.abs(this.corner.height) > .001) {
                ...
                for (var _iterator5 = this.corner.points, _isArray5 = Array.isArray(_iterator5), _i8 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator](); ; ) {
                    var _ref5;
                    if (_isArray5) {
                        if (_i8 >= _iterator5.length)
                            break;
                        _ref5 = _iterator5[_i8++]
                    } else {
                        if (_i8 = _iterator5.next(),
                        _i8.done)
                            break;
                        _ref5 = _i8.value
                    }
            ...
            for (var _iterator6 = this.markers, _isArray6 = Array.isArray(_iterator6), _i9 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator](); ; ) {
                var _ref6;
                if (_isArray6) {
                    if (_i9 >= _iterator6.length)
                        break;
                    _ref6 = _iterator6[_i9++]
                } else {
                    if (_i9 = _iterator6.next(),
                    _i9.done)
                        break;
                    _ref6 = _i9.value
                }
        ...
        SheetBlock.prototype.interpolate = function(x, y, xi) {
            if (!this.aSplines[x.length]) {
                ...
                for (var ps = this.aSplines[x.length].points, i = 0; i < x.length; ++i)
                    ps.push(new _libs.THREE.Vector3)
            }
            for (var spline = this.aSplines[x.length], _i10 = 0; _i10 < x.length; ++_i10)
        ...
        SheetBlock.prototype.loadPoints = function() {
            ...
            return {
                ...
                openedInterpolationIndeces: [[2, 3, 4], [2, 3, 4, 5, 6]],
    ...
    _libs.THREE.CSS3DRenderer = function CSS3DRenderer() {
        ...
        function renderObject(object, camera, cameraCSSMatrix) {
            if (object instanceof _libs.THREE.CSS3DObject) {
                var style;
                object instanceof _libs.THREE.CSS3DSprite ? (matrix.copy(camera.matrixWorldInverse),
                matrix.transpose(),
                ...
                style = getObjectCSSMatrix(matrix, cameraCSSMatrix)) : style = getObjectCSSMatrix(object.matrixWorld, cameraCSSMatrix);
                var element = object.element
                  , cachedStyle = cache.objects[object.id] && cache.objects[object.id].style;
                void 0 !== cachedStyle && cachedStyle === style || (element.style.WebkitTransform = style,
        ...
        var _width, _height, _widthHalf, _heightHalf, matrix = new _libs.THREE.Matrix4, cache = {
            camera: {
                fov: 0,
                style: ""
            },
        ...
        this.render = function(scene, camera) {
            ...
            cache.camera.fov !== fov && (domElement.style.WebkitPerspective = fov + "px",
            ...
            cache.camera.style === style || isIE || (cameraElement.style.WebkitTransform = style,
    ...
    var _libs = __webpack_require__(0)
      ...
      , CSSLayer = function(_CSS3DObject) {
        function CSSLayer(width, height, props) {
            ...
            _this.props = props,
            _this.jContainer = (0,
            _libs.$)('<div class="hidden css-layer"></div>');
        ...
        CSSLayer.prototype.setData = function setData() {
            ...
            this.clearInternals(),
            this.css = (0,
            _libs.$)('<style type="text/css">' + css + "</style>").appendTo(this.jContainer),
            this.html = (0,
            _libs.$)(html).appendTo(this.jContainer);
            var init = eval(js);
        ...
        CSSLayer.prototype.hide = function() {
            var _this3 = this
              , res = void 0;
            return this.isHidden() ? res = Promise.resolve() : (this.jContainer.addClass("hidden"),
        ...
        CSSLayer.prototype.show = function() {
            var _this4 = this
              , res = void 0;
            return this.isHidden() ? (this.jContainer.removeClass("hidden"),
...
, function(module, exports, __webpack_require__) {
    ...
    var Cache = function() {
        ...
        Cache.prototype.remove = function(k) {
            var res = !1
              , v = this.os.get(k);
            return v.locked && v.locked(k) || (this.size -= this.sizeof(v),
            v.dispose && v.dispose(),
            this.os.delete(k),
            res = !0),
            res
        ...
        Cache.recursionSizeof = function(value) {
            ...
            if (value) {
                ...
                if (void 0 === len)
                    for (var p in value)
                        value.hasOwnProperty(p) && (size += Cache.recursionSizeof(value[p]));
                else
                    size += len
            }
            return size
    ...
    var _extends = Object.assign || function(target) {
      ...
      , Finder = function() {
        function Finder(strs, pattern, props) {
            ...
            for (var p = 0; ; ) {
                if (-1 === (p = this.lstr.indexOf(this.pattern, p)))
                    break;
                this.addHits(p),
                this.addContext(p),
        ...
        Finder.prototype.merge = function() {
            for (var as = [], map = [], strs = this.strs, p = 0, i = 0; i < strs.length; ++i)
                strs[i].length && (map.push({
                    base: i,
                    offset: p
                }),
                as.push(strs[i]),
                p += strs[i].length,
                i < strs.length - 1 && !Finder.isDelimetr(strs[i].charAt(strs[i].length - 1)) && !Finder.isDelimetr(strs[i + 1].charAt(0)) && (as.push(Finder.DELIMITER),
                ++p));
            this.map = map,
            this.str = as.join("")
        }
    ...
    var _libs = __webpack_require__(0)
      ...
      , FullScreenX = function(_FullScreen) {
        function FullScreenX() {
            return _classCallCheck(this, FullScreenX),
            _possibleConstructorReturn(this, _FullScreen.apply(this, arguments))
        }
        return _inherits(FullScreenX, _FullScreen),
        ...
        FullScreenX.request = function(element) {
            _FullScreen.available.call(this) ? _FullScreen.request.call(this, element) : FullScreenX.node.hasClass(FullScreenX.classX) || (FullScreenX.node = (0,
            _libs.$)(element || document.body),
            FullScreenX.node.addClass(FullScreenX.classX),
            Promise.resolve().then(FullScreenX.handler))
        }
        ,
        FullScreenX.cancel = function() {
            _FullScreen.available.call(this) ? _FullScreen.cancel.call(this) : FullScreenX.node.hasClass(FullScreenX.classX) && (FullScreenX.node.removeClass(FullScreenX.classX),
...
, function(module, exports, __webpack_require__) {
    ...
    _libs.PDFJS.cMapUrl = (window.PDFJS_LOCALE ? PDFJS_LOCALE : __webpack_require__.i({
        pdfJsWorker: "js/pdf.worker.js",
        pdfJsCMapUrl: "cmaps/"
    })).pdfJsCMapUrl,
    ...
    var Pdf = function() {
        ...
        return Pdf.prototype.init = function(handler, pages) {
            ...
            this.doubledPages = !!pages && Math.abs(2 * Pdf.getPageSize(pages[0]).width - Pdf.getPageSize(pages[1]).width) / Pdf.getPageSize(pages[0]).width < .05;
        ...
        Pdf.prototype.getDestination = function(dest) {
            var _this2 = this
              , destPromise = void 0;
            return destPromise = "string" == typeof dest ? this.handler.getDestination(dest) : Promise.resolve(dest),
    ...
    var _libs = __webpack_require__(0)
      , ThreeEventConverterFs = function() {
        ...
        ThreeEventConverterFs.prototype.getObject = function(e) {
            return this.setCoordsFromEvent(e),
      ...
      , ThreeUtils = function() {
        ...
        return ThreeUtils.vertices2UVs = function(vertices, indeces, first, last, converClb) {
            for (var r = [], i = first; i < last; ++i)
                for (var vis = [indeces[i].a, indeces[i].b, indeces[i].c], j = 0; j < vis.length; ++j)
        ...
        ThreeUtils.findInternalVertices = function(geometry, ps, first, last) {
            for (var res = {}, i = first; i < last; ++i)
                for (var tri = geometry.faceVertexUvs[0][i], f = geometry.faces[i], vs = [f.a, f.b, f.c], j = 0; j < tri.length; ++j)
                    void 0 === res[vs[j]] && _BaseMathUtils2.default.isInsidePoly(ps, tri[j]) && (res[vs[j]] = {
                        p: tri[j],
                        i: vs[j],
                        n: f.vertexNormals[j]
                    });
...
, function(module, exports, __webpack_require__) {
    ...
    _libs.$.fn.FlipBook = function(options) {
        var scene = {
            dispose: function() {
                this.ready ? (!scene.pdfLinksHandler || scene.pdfLinksHandler.dispose(),
                ...
                scene.view.dispose(),
                delete scene.view,
                delete scene.dispose) : this.pendingDispose = !0
            }
        };
        options = _extends({}, options);
        var parentContainer = this.length ? this[0] : (0,
        _libs.$)("<div>").appendTo("body");
        return options.activateFullScreen && _FullScreenX2.default.request(parentContainer),
        scene.view = new _BookView2.default(parentContainer,function() {
            if (_Detector2.default.webgl) {
                scene.loadingCtrl = new _LoadingController2.default(scene.view,!0,function(progress) {
                    return 0 === progress ? (0,
                    _libs.tr)("Please wait... the Application is Loading") : (0,
                    _libs.tr)("PDF is Loading:") + " " + progress + "%"
                }
                ),
                ...
                scene.bookBuilder = function(props, sheets, pageCallback) {
                    ...
                    "pdf" === test.type && (scene.pdfLinksHandler = new _PdfLinksHandler2.default(test.src,scene.ctrl,scene.visual.element),
                ...
                options.pdf ? (scene.propsBuilder = new _PdfBookPropsBuilder2.default(options.pdf,scene.bookBuilder,options.bookStyle),
                scene.propsBuilder.pdf.setLoadingProgressClb(scene.loadingCtrl.setProgress.bind(scene.loadingCtrl)),
                scene.propsBuilder.pdf.setErrorHandler(options.error || onError)) : options.pageCallback ? (options.onPageCallbackError && options.onPageCallbackError.push(options.error || onError),
...
, function(module, exports, __webpack_require__) {
    ...
    Array.prototype.fill || (Array.prototype.fill = function(value) {
        ...
        for (var O = Object(this), len = O.length >>> 0, start = arguments[1], relativeStart = start >> 0, k = relativeStart < 0 ? Math.max(len + relativeStart, 0) : Math.min(relativeStart, len), end = arguments[2], relativeEnd = void 0 === end ? len : end >> 0, final = relativeEnd < 0 ? Math.max(len + relativeEnd, 0) : Math.min(relativeEnd, len); k < final; )
            O[k] = value,
            k++;
        return O
    }
    ...
    var _extends = Object.assign || function(target) {
      ...
      , AutoNavigator = function() {
        ...
        AutoNavigator.prototype.getPageNumber = function() {
            ...
            return (isNaN(number) || 0 === number) && (number = this.getParameterByName(this.urlParam),
    ...
    var _extends = Object.assign || function(target) {
      ...
      , Binder = function() {
        ...
        Binder.prototype.set = function(angle) {
            var right = void 0
              , left = void 0;
            angle > Math.PI / 2 ? (right = Math.PI / 2,
            left = angle - Math.PI / 2) : (right = angle,
            left = 0);
            var p = this.p
              , tr1 = {
                x: -.5 * p.cover.depth,
        ...
        Binder.prototype.setLeft = function(angle) {
            var PI = Math.PI;
            this.leftPivot.position.set(_MathUtils2.default.interpolateLinear([-PI, -PI / 2], [0, this.p.cover.depth], angle), .5 * this.p.backSize - .5 * this.p.cover.depth, 0),
            this.leftPivot.quaternion.setFromAxisAngle(this.OZ, angle)
        }
        ,
        Binder.prototype.setRight = function(angle) {
            var PI = Math.PI;
            this.rightPivot.position.set(_MathUtils2.default.interpolateLinear([-PI / 2, 0], [this.p.cover.depth, 0], angle), -.5 * this.p.backSize + .5 * this.p.cover.depth, 0),
    ...
    var _extends = Object.assign || function(target) {
      ...
      , Book = function(_THREE$EventDispatche) {
        function Book(visual, sheets, pageCallback, props) {
                ...
                play: function(player) {
                    if (player.play)
                        ...
                        (player.play() || {
                            ...
                            player.fb3dNoPlay || "NotAllowedError" !== e.name || (_this.pendingPlayers.push(player),
                            _this.dispatchEvent({
                                type: "pendingPlayers"
                            }))
                        });
                    else if ((0,
                    _libs.$)(player).hasClass("youtube")) {
                        var p = player.player;
                        player.fb3dNoPlay = !1,
                        p && p.playVideo ? p.playVideo() : setTimeout(function() {
            ...
            return _this.enableMouse(_this.p.interactiveCorners),
            2 === _this.getPages() && (_this.enableMouse(!1),
            ...
            _this.sheetBlocks = [],
            sheets > 0 && _this.addSheetBlock(0, new _SheetBlock2.default(visual,_extends({}, _this.p, {
            ...
            (0,
            _libs.$)(_this.visual.element).on("mousemove", _this.binds.lastMousePos),
            ...
            setTimeout(function() {
                _this.isProcessing() || (_this.notifyBeforeAnimation(),
        ...
        Book.prototype.dispose = function() {
            ...
            (0,
            _libs.$)(this.visual.element).off("mousemove", this.binds.lastMousePos),
        ...
        Book.prototype.setZoom = function(zoom, singlePage) {
            (Math.abs(this.p.zoom - zoom) > .001 || singlePage !== this.p.singlePage) && (this.p.zoom = zoom,
        ...
        Book.prototype.getPage = function() {
            ...
            if (this.angle === PI / 2 || this.angle === 3 * PI / 2) {
                ...
                this.angle < PI / 2 ? p = 0 : this.angle > 3 * PI / 2 ? p = 1 : this.angle < PI ? p = this.getBookPages() - 3 : this.angle >= PI && (p = this.getBookPages() - 1);
            return p
        }
        ,
        ...
        Book.prototype.getLeftFlipping = function() {
            var block = void 0
              ...
              , PI = Math.PI;
            return this.angle === PI ? this.getPages() > 1 && (block = this.rightCover) : left && "closed" === left.state && left.angle > PI / 2 ? block = left : this.angle !== PI / 2 && this.angle !== 3 * PI / 2 || this.p.rtl && this.getPages() !== this.getBookPages() || (block = this.leftCover),
            block
        }
        ,
        Book.prototype.getRightFlipping = function() {
            var block = void 0
              ...
              , PI = Math.PI;
            return 0 === this.angle ? this.getPages() > 1 && (block = this.leftCover) : right && "closed" === right.state && right.angle <= PI / 2 ? block = right : this.angle !== PI / 2 && this.angle !== 3 * PI / 2 || (this.p.rtl || this.getPages() === this.getBookPages()) && (block = this.rightCover),
            block
        }
        ,
        ...
        Book.prototype.flipLeft = function() {
            ...
            if (this.sheetPhysics.getSize() < 25) {
                ...
                }, progressClb) : left && "closed" === left.state && left.angle > PI / 2 ? (block = size < left.getSize() ? this.splitSheetBlock(0, left.getSize() - size)[1] : left,
        ...
        Book.prototype.flipRight = function() {
            ...
            if (this.sheetPhysics.getSize() < 25) {
                ...
                }, progressClb) : right && "closed" === right.state && right.angle <= PI / 2 ? (block = size < right.getSize() ? this.splitSheetBlock(this.sheetBlocks.length - 1, size)[0] : right,
        ...
        Book.prototype.xSegment = function() {
            var boxs = this.tmp.boxs
              , res = {};
            return this.leftCover.physicId ? (boxs[0].setFromObject(this.rightCover.three),
            res.min = -(res.max = boxs[0].max.x)) : this.rightCover.physicId ? (boxs[0].setFromObject(this.leftCover.three),
        ...
        Book.prototype.onPickCallback = function(object) {
            ...
            return i < 2 && (p.x = 0 === i ? p.x : 1 - p.x,
            block.cornerTarget.testIntersection(null, p) && block.physicId && (this.hoverInfo && this.clearHoverInfo(),
        ...
        Book.prototype.onDragCallback = function(point) {
            ...
            block.getProps();
            return block.force = _SheetPhysics2.default.dragForceClb,
        ...
        Book.prototype.cornerCallback = function(e, data) {
            ...
            if (this.mouseController) {
                ...
                if ("mouseover" === e.type) {
                    ...
                    else if (this.hoverInfo && (console.warn("Wrong state: element is already hover"),
                    ...
                    !this.hoverInfo && !this.dragInfo) {
                        ...
                        if (n > 1 && n < 2 * (this.p.sheets + 1) && hover.physicId && (hover.angle < .02 || hover.angle > Math.PI - .02))
                        ...
                        res.then(function(block) {
                            if (_this4.hoverInfo && _this4.hoverInfo.pendings < 1 && (block = void 0,
                            delete _this4.hoverInfo),
                            block) {
                                _this4.pageManager.turnOffEvents();
                                var p = block.getProps();
                                block.force = _this4.sheetPhysics.getTargetForceClb(p.mass * block.getSize(), i ? Math.PI - .02 : .02),
                                block.cornerForce = function() {
                                    return (i ? -1 : 1) * _SheetPhysics2.default.hoverCornerForceClb()
                                }
                                ,
                                _this4.sheetPhysics.setParametr(block.physicId, "angle", i ? Math.PI - .01 : .01),
                                _this4.hoverInfo = {
                                    n: n,
                                    block: block
                                },
                    ...
                    void 0 !== this.hoverInfo.pendings ? --this.hoverInfo.pendings : n === this.hoverInfo.n && this.clearHoverInfo();
        ...
        Book.prototype.notifyBeforeAnimation = function() {
            var res = void 0;
            return this.animationNotification ? res = Promise.reject() : (this.animationNotification = !0,
            this.dispatchEvent({
        ...
        Book.prototype.notifyAfterAnimation = function() {
            if (this.animationNotification) {
                var p = this.getPage();
                this.userDirection.lastTopPage !== p && (this.userDirection.direction = Math.sign(p - this.userDirection.lastTopPage),
        ...
        Book.prototype.update = function(dt) {
            ...
            this.isProcessing() && void 0 !== this.lastMousePos.pageX && this.lastMousePos.t - (this.lastMousePos.lastT || 0) > .25 && !this.hoverInfo && !this.dragInfo && (this.lastMousePos.lastT = this.lastMousePos.t,
            Promise.resolve().then(function() {
                (0,
                _libs.$)(_this7.visual.element).trigger(_libs.$.Event("mousemove", _this7.lastMousePos))
            })),
        ...
        Book.createSideTexture = function(color, type) {
            ...
            if ("color" === type) {
                ...
                ctx.fill(),
                ctx.beginPath(),
                ctx.fillStyle = _GraphUtils2.default.color2Rgba(_GraphUtils2.default.inverseColor(color, .5), 1),
                ctx.rect(0, 7, 8, 1),
                ctx.fill()
            }
            return c
        ...
        Book.prototype.prepareProps = function(props) {
            return this.calcProps(Book.mergeProps((0,
            _book.props)(), props))
        }
        ,
        ...
        Book.prototype.calcProps = function(props) {
            ...
            return cover.color === sheet.color || p.cover.sideTexture || (cover.sideTexture = Book.createSideTexture(cover.color, cover.side)),
            page.color === sheet.color || p.page.sideTexture || (page.sideTexture = Book.createSideTexture(page.color, page.side)),
            p.cssLayersLoader && (p.cssLayersLoader = this.cssLayersLoader(p.cssLayersLoader)),
            _extends({}, p, {
                scale: 10,
                height: height,
                width: width,
        ...
        Book.prototype.cssLayerJsObjectInit = function(c, p) {
            ...
            c.find(".go-to-page").on("click", function(e) {
                for (var n = (0,
                _libs.$)(e.target); n.length && !n.hasClass("go-to-page"); )
                    n = (0,
                    _libs.$)(n[0].parentNode);
                n = parseInt(n.attr("data-number")),
                isNaN(n) || (e.preventDefault(),
                p.scene.ctrl.goToPage(n - 1))
            });
            var ys = c.find(".youtube");
            return ys.length && (ys.html('<div style="width:100%;height:100%;"></div>'),
            ...
            {
                hide: function() {
                    _this10.pendingPlayers.length && (_this10.pendingPlayers = [],
    ...
    : function(obj) {
      ...
      , BookController = function(_Controller) {
        function BookController(book, view, props) {
            ...
            return _this.bookWatcher = new _Object3DWatcher2.default(_this.visual,function() {
                if (_this.state.singlePage)
                    _this.state.activeSide ? box0.setFromObject(book.rightCover.three) : box0.setFromObject(book.leftCover.three);
                else {
                    ...
                    box0.min.x = x0 - .5 * width,
                    box0.max.x = x0 + .5 * width
                }
                return box0
            }
            ),
        ...
        BookController.prototype.initLoadingAnimation = function() {
            var _this3 = this
              , handler = function() {
                for (var pages = _this3.book.getTopPages(), visible = !1, _iterator = pages, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator](); ; ) {
                    var _ref;
                    if (_isArray) {
                        if (_i >= _iterator.length)
                            break;
                    ...
                    var n = _ref
                      , state = _this3.book.getPageState(n);
        ...
        BookController.prototype.cmdZoomIn = function() {
            this.state.smartPan ? (this.bookWatcher.scale = Math.min(this.p.scale.max, this.bookWatcher.scale + this.p.scale.delta),
            this.setBookZoom(this.bookWatcher.scale)) : this.orbit.zoomIn(6.6 * this.p.scale.delta / .32),
            this.updateView()
        }
        ,
        BookController.prototype.cmdZoomOut = function() {
            this.state.smartPan ? (this.bookWatcher.scale = Math.max(this.p.scale.min, this.bookWatcher.scale - this.p.scale.delta),
            this.setBookZoom(this.bookWatcher.scale)) : this.orbit.zoomOut(6.6 * this.p.scale.delta / .32),
            this.updateView()
        }
        ,
        ...
        BookController.prototype.cmdDefaultZoom = function() {
            this.state.smartPan && (this.bookWatcher.scale = this.p.scale.default,
            this.setBookZoom(this.bookWatcher.scale),
            this.updateView())
        }
        ,
        ...
        BookController.prototype.cmdBackward = function() {
            var _this4 = this;
            this.canFlipLeft() && (this.state.singlePage ? (this.state.activeSide = (this.getPage() + 1) % 2,
            this.state.activeSide ? (this.state.activeSide = 0,
            this.updateView()) : this.startFlip(this.book.flipLeft(1)).then(function(block) {
        ...
        BookController.prototype.cmdForward = function() {
            var _this5 = this;
            this.canFlipRight() && (this.state.singlePage ? (this.state.activeSide = (this.getPage() + 1) % 2,
            this.state.activeSide ? this.startFlip(this.book.flipRight(1)).then(function(block) {
                block && (_this5.state.activeSide = 0)
            }) : (this.state.activeSide = 1,
            this.updateView())) : this.startFlip(this.book.flipRight(1)))
        }
        ,
        ...
        BookController.prototype.cmdSave = function() {
            var a = (0,
            _libs.$)('<a href="' + this.p.downloadURL + '" download target="_blank"></a>').appendTo(this.view.getContainer());
            a[0].click(),
            a.remove()
        }
        ,
        ...
        BookController.prototype.cmdSmartPan = function() {
            ...
            this.state.smartPan ? (this.orbit.minAzimuthAngle = 0,
            this.orbit.maxAzimuthAngle = 0,
            this.orbit.minPolarAngle = 0,
            this.orbit.maxPolarAngle = Math.PI / 4,
            this.bookWatcher.enabled = !0) : (this.orbit.minAzimuthAngle = -1 / 0,
        ...
        BookController.prototype.cmdSinglePage = function() {
            this.isSinglePageAvailable() && (this.state.singlePage = !this.state.singlePage,
            this.setBookZoom(this.bookWatcher.scale),
            this.updateView(),
            this.dispatchAsync({
                type: "pageMode",
        ...
        BookController.prototype.cmdStats = function() {
            ...
            this.state.stats ? ((0,
            _libs.$)(this.view.getContainer()).append(this.Stats.domElement),
            this.visual.addRenderCallback(this.binds.stats)) : ((0,
            _libs.$)(this.view.getContainer()).find(this.Stats.domElement).remove(),
        ...
        BookController.prototype.goToPage = function(page) {
            ...
            var target = Math.max(Math.min(page - 1 + page % 2, this.book.getBookPages() - 1), 0)
              ...
              , covs = 0;
            if (target != current) {
                0 === current ? (flips.push(1),
                current += 1,
                ++covs) : current === this.book.getBookPages() - 1 && (flips.push(-1),
                current -= 2,
                ++covs);
                var cv = 0;
                0 === target ? (cv = -1,
                target += 1,
                ++covs) : target === this.book.getBookPages() - 1 && (cv = 1,
                target -= 2,
                ++covs),
        ...
        BookController.prototype.getPageForGUI = function() {
            ...
            return this.p.rtl && (n = this.book.getBookPages() - n + 1),
        ...
        BookController.prototype.isCmdVisible = function(name) {
            return (0,
            _libs.$)(this.visual.element).width() < this.p.narrowView.width ? void 0 === this.actions[name].enabledInNarrow ? this.actions[name].enabled : this.actions[name].enabledInNarrow : this.actions[name].enabled
        }
        ,
        ...
        BookController.prototype.getActions = function() {
            ...
            return _extends({}, cmds, {
                ...
                touchCmdRotate: {
                    activate: function(e, data) {
                        isSwipping("touchCmdRotate") || ("move" === data.state && e.preventDefault(),
                ...
                touchCmdZoom: {
                    activate: function(e, data) {
                        if (!isSwipping("touchCmdZoom")) {
                            ...
                            "start" === data.state ? _this8.touchZoomData = {
                                l: l(data),
                ...
                touchCmdPan: {
                    activate: function(e, data) {
                        isSwipping("touchCmdPan") || "move" === data.state && (!_this8.state.smartPan || _this8.bookWatcher.scale > 1) && (e.preventDefault(),
                    ...
                    activate: function(e, data) {
                        if (isSwipping("touchCmdSwipe"))
                            if ("start" === data.state) {
                                ...
                                "move" === data.state ? (e.preventDefault(),
                                _this8.swipeData.handled || (_this8.swipeData = _extends({}, _this8.swipeData, {
                                    x: _this8.swipeData.x + data.dx,
                                    y: _this8.swipeData.y + data.dy
                                }),
                                Math.abs(_this8.swipeData.x0 - _this8.swipeData.x) > 100 && (_this8.swipeData.x0 > _this8.swipeData.x ? _this8.cmdForward() : _this8.cmdBackward(),
                                _this8.swipeData.handled = !0))) : delete _this8.swipeData
                    }
                },
                widSettings: {
                    activate: function() {}
        ...
        BookController.prototype.bindActions = function() {
            this.eToA = new _EventsToActions2.default((0,
            _libs.$)(this.visual.element)),
        ...
        BookController.prepareProps = function(props) {
            return BookController.calcProps(BookController.mergeProps((0,
            _bookController.props)(), props))
        }
        ,
    ...
    var _libs = __webpack_require__(1)
      , BookPrinter = function() {
        ...
        BookPrinter.prototype.print = function() {
            var _this = this;
            if (delete this.canceled,
            "pdf" === this.type) {
                var printWnd = void 0
                  , callManually = !1;
                this.useIFrame() ? (callManually = !!this.frame,
                this.frame || (this.frame = (0,
                _libs.$)('<iframe src="' + this.pdfSrc + '" style="display: none;"></iframe>').appendTo(this.doc.body)),
                printWnd = this.frame[0].contentWindow) : printWnd = this.wnd.open(this.pdfSrc),
                callManually ? printWnd.print() : (0,
                _libs.$)(printWnd).on("load", function() {
                    try {
                        printWnd.print()
                    } catch (e) {
                        console.error(e)
        ...
        BookPrinter.prototype.renderContent = function() {
            for (var _this2 = this, pages = this.book.getPages(), head = new Set, body = [], done = Promise.resolve(), page = 0; page < pages; ++page)
                !function(page) {
    ...
    var _extends = Object.assign || function(target) {
      ...
      , CssLayersManager = function() {
        ...
        return CssLayersManager.prototype.getActives = function() {
            ...
            return this.wrappers[0] || 0 === page || (acs = [0].concat(acs)),
            acs
        }
        ,
                    ...
                    if (w) {
                        ...
                        Promise.resolve().then(function() {
                            _this.pageManager.getLayers(n, function(layers) {
                                ...
                                if (!_this.wrappers || 0 !== n && "loading" === _this.wrappers[0].state)
    ...
    var _extends = Object.assign || function(target) {
      ...
      , PageManager = function() {
        function PageManager(visual, book, p) {
            ...
            visual.addObject(new _libs.THREE.Mesh(new _libs.THREE.PlaneGeometry(.001,.001),this.tmpMaterial)),
        ...
        PageManager.prototype.load = function(material, n) {
            ...
            Promise.resolve().then(function() {
                if (o.texture) {
                    ...
                    o.wrapper = _this3.imageFactory.build(pi, void 0 === pi.number ? _this3.rtlPageN(n) : pi.number, res.width, res.height, p.color, _this3.p.injector),
                    o.wrapper.setQuery && o.wrapper.setQuery(_this3.pageQuery),
                    o.simulate = pi.interactive ? (o.wrapper.simulate || function() {}
                    ).bind(o.wrapper) : void 0,
                    ...
                    o.wrapper.onChange = function(image) {
                        o.texture && (_this3.removeFromLoadings(o),
                        o.material && (o.material.map = o.texture,
                        ...
                        o.texture.onUpdate = function() {
                            setTimeout(function() {
                                "queuedForRender" !== o.state && (o.state = "active",
        ...
        PageManager.prototype.pushInRenderQueue = function(o) {
            "queuedForRender" !== o.state && "loading" !== o.state && (o.state = "queuedForRender",
            ...
            if (this.canvases) {
                ...
                if (this.rendering)
                    ...
                    for (var active = void 0, top = void 0, _iterator7 = this.renderQueue, _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator](); ; ) {
                        ...
                        var _o2 = _ref7;
                        if (!active && _o2.isActive() && (active = _o2),
                        _o2.isTop()) {
                            top = _o2;
                            break
                        }
                    }
                    if (this.rendering = top || active,
                    (this.isMobile() && p.renderInactivePagesOnMobile || !this.isMobile() && p.renderInactivePages) && !this.rendering)
                        for (var ud = this.book.getUserDirection(), near = {}, _iterator8 = this.renderQueue, _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _iterator8[Symbol.iterator](); ; ) {
                            ...
                            (!near[id] || Math.abs(near[id].n - ud.lastTopPage) > Math.abs(o.n - ud.lastTopPage)) && (near[id] = o),
                            this.rendering = near[1 === ud.direction] || near[1 !== ud.direction]
                        }
                    if (this.rendering)
        ...
        PageManager.prototype.turnOffEvents = function() {
            ...
            this.pageCache.forEach(function(ent) {
                var object = ent[1];
                object.simulate && (object.simulate(mouseup, void 0, 0, 0),
        ...
        PageManager.prototype.loadPredictedPages = function() {
            ...
            Promise.resolve().then(function() {
                ...
                for (var i = 0, p = ud.lastTopPage + ud.direction; i < _this4.p.preloadPages; ++i,
                p += ud.direction)
        ...
        PageManager.prototype.setMaterial = function(o, material) {
            ...
            material && material !== o.material && (o.material = material,
            this.setupMaterial(o))
        }
        ,
        ...
        PageManager.prototype.getOrLoadTextureObject = function(material, n) {
            var object = this.pageCache.get(n);
            return object ? this.setMaterial(object, material) : object = this.load(material, n),
            object
        }
        ,
    ...
    var _BookPropsBuilder2 = __webpack_require__(9)
      ...
      , PdfBookPropsBuilder = function(_BookPropsBuilder) {
        function PdfBookPropsBuilder(src, onReady, style) {
            ...
            var _this = _possibleConstructorReturn(this, _BookPropsBuilder.call(this, onReady, style));
            return _this.pdf = new _Pdf2.default(src),
        ...
        SearchEngine.prototype.process = function() {
            ...
            if (this.update) {
                ...
                this.find(this.pageCallback(this.page)).then(function(contexts) {
                    ...
                    _this.onPageHitsChanged && _this.onPageHitsChanged(_this.page, _this.query),
                    ++_this.page,
                    _this.process())
                })
            }
...
, function(module, exports, __webpack_require__) {
    ...
    var _libs = __webpack_require__(1)
      ...
      , ShareController = function(_WidgetController) {
        ...
        return _inherits(ShareController, _WidgetController),
        ...
        ShareController.prototype.clickLink = function(u) {
            var blank = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]
              , a = (0,
            _libs.$)('<a href="' + u + '"' + (blank ? ' target="_blank"' : "") + "></a>").appendTo(this.view.getContainer());
            a[0].click(),
            a.remove()
        }
        ,
        ...
        ShareController.prototype.cmdEmail = function() {
            this.clickLink("mailto:?subject=" + (0,
            _libs.tr)("We wanted you to see this book") + "&body=" + (0,
            _libs.tr)("Check out this site") + " " + encodeURIComponent(this.getLink()), !1)
        }
        ,
      ...
      , SheetPhysics = function() {
                    ...
                    if (1 === ci.num) {
                        ...
                        for (var _iterator2 = gs, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator](); ; ) {
                            ...
                            var g = _ref2
                              , sg = void 0
                              , i0 = void 0;
                            nos[g[0]].l > Math.PI / 2 * this.p.r ? (sg = -1,
                            i0 = g[g.length - 1]) : (sg = 1,
                            i0 = g[0]);
                            for (var _i3 = i0; _i3 < nos.length && _i3 > -1; _i3 += sg) {
                                ...
                                (o.l > this.p.l || o.l < 0) && (o.l = o.l > this.p.l ? this.p.l : 0,
                                o.ch = 0,
                                o.v = 0,
        ...
        SheetPhysics.prototype.findCollisions = function(os) {
            for (var ci = {
                ...
                last: 0,
                all: []
            }, i = 1; i < os.length && ci.num < 2; ++i)
                (os[i - 1].l > os[i].l || this.isCollision(os[i - 1], os[i])) && (os[i - 1].l > os[i].l && ++ci.num,
                ++ci.num,
                ci.last = i,
        ...
        SheetPhysics.prototype.integrate = function(os, dt) {
            for (var nos = [], _iterator6 = os, _isArray6 = Array.isArray(_iterator6), _i7 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator](); ; ) {
                ...
                (no.l <= 0 || no.l >= this.p.l) && (no.l = no.l <= 0 ? 0 : this.p.l,
                no.v = 0,
                no.ch = 0),
                nos.push(no)
            }
...
, function(module, exports, __webpack_require__) {
    ...
    var SoundsEnviroment = function() {
        ...
        SoundsEnviroment.prototype.endFlip = function() {
            this.enabled && this.audio.startFlip && (this.audio.startFlip.pause(),
    ...
    var _WidgetController2 = __webpack_require__(22)
      ...
      , TocController = function(_WidgetController) {
        ...
        TocController.prototype.setBookmarks = function(bookmarks, pdf) {
            ...
            bookmarks.getSize() && (this.tab = "bookmarks",
            this.isBookmarks = !0),
            this.fireChange()
        }
        ,
...
, function(module, exports, __webpack_require__) {
    ...
    exports.__esModule = !0;
    var _ImageBase2 = (__webpack_require__(0),
        ...
        function Bookmarks(container, items) {
            ...
            this.binds = {
                togle: function(e) {
                    e.preventDefault();
                    for (var li = (0,
                    _libs.$)(e.target); li[0] && li[0] !== container[0] && !li.hasClass("item"); )
                        li = (0,
                        _libs.$)(li[0].parentNode);
                    if (li.hasClass("item")) {
                        for (var cmd = (0,
                        _libs.$)(e.target); cmd[0] && cmd[0] !== li[0] && !cmd.hasClass("cmd"); )
                            cmd = (0,
                            _libs.$)(cmd[0].parentNode);
                        if (cmd.hasClass("cmd")) {
                            var node = _this.map[li.attr("data-id")];
                            cmd.hasClass("togle") ? (node.minimized = !node.minimized,
                            node.minimized ? (li.find("ul").remove(),
                            li.find(".togle").addClass("minimized")) : (li.find(".togle").removeClass("minimized"),
    ...
    var _libs = __webpack_require__(0)
      , DocMouseSimulator = function() {
        ...
        DocMouseSimulator.prototype.triggerEvent = function(element, e, p, type, advancedProps) {
            ...
            (0,
            _libs.$)(element).trigger(jE)
        }
        ,
        DocMouseSimulator.prototype.addClass = function(element, name) {
            (0,
            _libs.$)(element).addClass(name);
            var style = this.wnd.getComputedStyle(element);
            this.cursors.push((0,
            _libs.$)(this.bElement).css("cursor")),
            (0,
            _libs.$)(this.bElement).css("cursor", style.getPropertyValue("cursor"))
        }
        ,
        DocMouseSimulator.prototype.removeClass = function(element, name) {
            (0,
            _libs.$)(element).removeClass(name),
            (0,
            _libs.$)(this.bElement).css("cursor", this.cursors.pop())
        }
        ,
        ...
        DocMouseSimulator.prototype.simulate = function(e, doc, x, y) {
            ...
            switch (e.type) {
            case "mousedown":
                this.capElement && (this.deactivateElement(this.capElement),
                notify = !0),
                this.capElement = element,
                this.capElement && (this.activateElement(this.capElement),
                notify = !0);
                break;
            case "mouseup":
                this.capElement && (this.deactivateElement(this.capElement),
    ...
    var Dom2Image = function Dom2Image(wnd, doc, cache) {
        ...
        function draw(domNode, options) {
            function newCanvas(domNode) {
                ...
                if (canvas.width = options.width || util.width(domNode),
        ...
        function cloneNode(node, filter, root) {
            ...
            function processClone(original, clone) {
                ...
                function fixSvg() {
                    util.isSVG(clone) && (clone.setAttribute("xmlns", "http://www.w3.org/2000/svg"),
                    util.isSVGRect(clone) && ["width", "height"].forEach(function(attribute) {
        ...
        var util = function() {
            ...
            function getAndEncode(url) {
                ...
                if (data)
                    return data.content ? data.content : new Promise(function(resolve) {
                    ...
                    function done() {
                        if (4 === request.readyState) {
                            if (200 !== request.status)
                                return void fail("cannot fetch resource: " + url + ", status: " + request.status);
            ...
            function asArray(arrayLike) {
                for (var array = [], length = arrayLike.length, i = 0; i < length; i++)
          ...
          , inliner = function() {
            ...
            function readUrls(string) {
                for (var result = [], match = void 0; null !== (match = URL_REGEX.exec(string)); )
                    result.push(match[1]);
    ...
    var _libs = __webpack_require__(0)
      , Drag = function() {
        function Drag(wnd, doc, visualWorld) {
            ...
            (0,
            _libs.$)(this.element).on("mousemove", this.binds.onMouseMove),
            (0,
            _libs.$)(this.element).on("mousedown", this.binds.onMouseDown),
            (0,
            _libs.$)(this.doc).on("mouseup", this.binds.onMouseUp)
        }
        ...
        Drag.prototype.dispose = function() {
            (0,
            _libs.$)(this.element).off("mousemove", this.binds.onMouseMove),
            (0,
            _libs.$)(this.element).off("mousedown", this.binds.onMouseDown),
            (0,
            _libs.$)(this.doc).off("mouseup", this.binds.onMouseUp)
        }
        ,
        ...
        Drag.prototype.onMouseDown = function(e) {
            if (this.enabled) {
                ...
                if (intersects.length > 0) {
                    ...
                    if (!this.onPickCallback(intersects[0]))
                        return;
        ...
        Drag.prototype.onMouseMove = function(e) {
            ...
            this.selected && (this.setCoordsFromEvent(e),
            this.raycaster.setFromCamera(this.coords, this.camera),
        ...
        Drag.prototype.onMouseUp = function(e) {
            this.selected && (this.onReleaseCallback(),
            this.selected = null,
...
, function(module, exports, __webpack_require__) {
    ...
    var EventsToActions = function() {
        function EventsToActions(element, actions) {
            ...
            (0,
            _libs.$)(this.doc).on("mousemove", this.binds.mouseMoveDoc),
            (0,
            _libs.$)(this.doc).on("mouseup", this.binds.mouseUpDoc),
            ...
            (0,
            _libs.$)(this.wnd).on("keydown", this.binds.keyDown),
            (0,
            _libs.$)(this.wnd).on("keypress", this.binds.keyPress),
            (0,
            _libs.$)(this.wnd).on("keyup", this.binds.keyUp)
        }
        ...
        EventsToActions.getPosition = function(touches) {
            var x = void 0
              , y = void 0;
            return 2 === touches.length ? (x = touches[1].pageX - touches[0].pageX,
            y = touches[1].pageY - touches[0].pageY) : (x = touches[0].pageX,
            y = touches[0].pageY),
            {
                x: x,
                y: y
        ...
        EventsToActions.prototype.mouseDown = function(e) {
            if (this.picked && this.mouseUpDoc(),
            this.enabled) {
                var flags = EventsToActions.getEventFlags(e);
        ...
        EventsToActions.prototype.touchStart = function(e) {
            if (this.touchPicked && this.touchEnd(e),
            this.enabled) {
                var flags = EventsToActions.getEventFlags(e)
        ...
        EventsToActions.prototype.touchMove = function(e) {
            if (this.enabled) {
                var flags = EventsToActions.getEventFlags(e)
                  , touches = e.touches || e.originalEvent.touches;
                if (this.fireActions(this.getActions("touchmove", touches.length, flags), e),
                this.touchPicked)
        ...
        EventsToActions.prototype.dispose = function() {
            ...
            (0,
            _libs.$)(this.doc).off("mousemove", this.binds.mouseMoveDoc),
            (0,
            _libs.$)(this.doc).off("mouseup", this.binds.mouseUpDoc),
            ...
            (0,
            _libs.$)(this.wnd).off("keydown", this.binds.keyDown),
            (0,
            _libs.$)(this.wnd).off("keypress", this.binds.keyPress),
            (0,
            _libs.$)(this.wnd).off("keyup", this.binds.keyUp)
        }
        ,
        EventsToActions
    }();
...
, function(module, exports, __webpack_require__) {
    ...
    var FullScreen = function() {
        ...
        FullScreen.addEventListener = function(element, handler) {
            element.addEventListener && (element.addEventListener("webkitfullscreenchange", handler, !1),
        ...
        FullScreen.removeEventListener = function(element, handler) {
            element.removeEventListener && (element.removeEventListener("webkitfullscreenchange", handler, !1),
    ...
    var _libs = __webpack_require__(0)
      ...
      , InteractiveImage = function(_ImageBase) {
        function InteractiveImage(context, width, height, color, src, cache, injector) {
            ...
            var jFrame = (0,
            _libs.$)('<iframe id="' + _this.iId + '" src="' + src + '" style="position: fixed; left: -1000px;"></iframe>');
            return (0,
            _libs.$)(_this.doc.body).append(jFrame),
            _this.frame = jFrame[0],
            _this.binds = {},
            injector && injector(_this.frame.contentWindow),
            _this.doc.implementation.hasFeature("www.http://w3.org/TR/SVG11/feature#Extensibility", "1.1") && (_this.image = new Image,
            ...
            ,
            (0,
            _libs.$)(_this.image).on("load", _this.binds.imageLoad),
            ...
            _this.binds.frameLoad = function() {
                ...
                _this.finishLoad()) : setTimeout(function() {
                    _this.frame && (_this.width = (0,
                    _libs.$)(_this.frame.contentDocument.body).width(),
                    _this.height = (0,
                    _libs.$)(_this.frame.contentDocument.body).height(),
                    ...
                    _this.svgRender && (_this.simulator = new _DocMouseSimulator2.default(jFrame,_this.frame.contentDocument.body,_this.element),
            ...
            ,
            (0,
            _libs.$)(_this.frame.contentWindow).on("load", _this.binds.frameLoad),
            _this
        }
        ...
        InteractiveImage.prototype.render = function() {
            ...
            _libs.html2canvas)(this.frame.contentDocument.body, {
                timeout: 3e4
        ...
        InteractiveImage.prototype.dispose = function() {
            (0,
            _libs.$)(this.image).off("load", this.binds.imageLoad),
            (0,
            _libs.$)(this.frame.contentWindow).off("load", this.binds.frameLoad),
            (0,
            _libs.$)(this.doc.body).find("#" + this.iId).remove(),
      ...
      , LoadingAnimation = function() {
        ...
        LoadingAnimation.prototype.calcTimeTo = function(target) {
            for (var t = 0, dt = this.p.dt, os = this.os; Math.abs(os[1] - target) > 1e-4; ) {
                ...
                nos[0] < 0 && nos[1] < target || nos[0] > 0 && nos[1] > target ? dt /= 2 : (os = nos,
                t += dt)
            }
            return t
        }
        ...
        LoadingAnimation.prototype.update = function(T) {
            ...
            this.t >= this.p.updateInterval) {
                ...
                ctx.beginPath(),
                ctx.shadowBlur = 50,
                ctx.fillStyle = _GraphUtils2.default.color2Rgba(_GraphUtils2.default.inverseColor(this.p.color, .9), Math.abs(this.os[0] / 6.36)),
                ctx.shadowColor = _GraphUtils2.default.color2Rgba(_GraphUtils2.default.inverseColor(this.p.color, 1), .9),
                ctx.shadowOffsetX = 0,
                ctx.shadowOffsetY = 0,
                ...
                ctx.fillText((0,
                _libs.tr)("Loading..."), x0, y0);
                var da = 2 * Math.PI / 10;
                ctx.shadowColor = _GraphUtils2.default.color2Rgba(_GraphUtils2.default.inverseColor(this.p.color, 1), .7);
                for (var i = 0, _a = a, _r = .2 * r; i < 10; ++i,
                _r *= .9,
                _a += da) {
                    ctx.beginPath(),
                    ctx.fillStyle = _GraphUtils2.default.color2Rgba(_GraphUtils2.default.inverseColor(this.p.color, (10 - i) / 10), .7 * (10 - i) / 10);
...
, function(module, exports, __webpack_require__) {
    ...
    exports.__esModule = !0;
    var LoadingController = (__webpack_require__(0),
    function() {
    ...
    var _libs = __webpack_require__(0)
      ...
      , MouseEventConverter = function(_EventConverter) {
        function MouseEventConverter(wnd, doc, element) {
            ...
            (0,
            _libs.$)(_this.element).on("mousemove mousedown mouseover mouseout click", _this.binds.convert),
            (0,
            _libs.$)(_this.doc).on("mouseup", _this.binds.convert),
            _this
        }
        return _inherits(MouseEventConverter, _EventConverter),
        MouseEventConverter.prototype.dispose = function() {
            (0,
            _libs.$)(this.element).off("mousemove mousedown mouseover mouseout click", this.binds.convert),
            (0,
            _libs.$)(this.doc).off("mouseup", this.binds.convert)
        }
        ,
        MouseEventConverter
    }(_EventConverter3.default);
      ...
      , Orbit = function(_THREE$EventDispatche) {
        function Orbit(object, domElement) {
            ...
            function dollyIn(dollyScale) {
                scope.object instanceof _libs.THREE.PerspectiveCamera ? scale /= dollyScale : scope.object instanceof _libs.THREE.OrthographicCamera ? (scope.object.zoom = Math.max(scope.minZoom, Math.min(scope.maxZoom, scope.object.zoom * dollyScale)),
            ...
            function pan(event, data) {
                scope.enabled && scope.enablePan && "move" === data.state && (scope.pan(data.dx, data.dy),
                scope.update())
            }
            function offsetDolly(event, data) {
                scope.enabled && scope.enableZoom && "move" === data.state && (data.dy > 0 ? dollyIn(getZoomScale()) : data.dy < 0 && dollyOut(getZoomScale()),
                scope.update())
            }
            function wheelDolly(event) {
                scope.enabled && scope.enableZoom && (event.deltaY > 0 ? dollyOut(getZoomScale()) : event.deltaY < 0 && dollyIn(getZoomScale()),
                scope.update())
            }
            ...
            _this.update = function() {
                ...
                return function() {
                    ...
                    scale = 1,
                    panOffset.set(0, 0, 0),
                    !!(zoomChanged || lastPosition.distanceToSquared(scope.object.position) > EPS || 8 * (1 - lastQuaternion.dot(scope.object.quaternion)) > EPS) && (scope.dispatchEvent(changeEvent),
            ...
            return scope.pan = function() {
                ...
                return function(deltaX, deltaY) {
                    ...
                    if (scope.object instanceof _libs.THREE.PerspectiveCamera) {
                        ...
                        scope.object instanceof _libs.THREE.OrthographicCamera ? (panLeft(deltaX * (scope.object.right - scope.object.left) / scope.object.zoom / element.clientWidth, scope.object.matrix),
    ...
    var _libs = __webpack_require__(0)
      ...
      , PdfImage = function(_ImageBase) {
        ...
        PdfImage.prototype.setHits = function(textContent) {
            ...
            "" !== this.query && (this.finder = new _Finder2.default(textContent.items.map(function(item) {
                return item.str
            }),this.query,{
                contexts: !1
            }))
        ...
        PdfImage.prototype.renderHits = function() {
            var _this3 = this;
            if (this.finder) {
                for (var testSz = (this.page.view,
                (0,
                _libs.$)('<div style="position: absolute; visibility: hidden;"></div>').appendTo("body")), textDiv = testSz[0], baseOffset = testSz.offset().left, _iterator3 = this.finder.getHits(), _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator](); ; ) {
                    var _ref3;
                    if (_isArray3) {
                        if (_i3 >= _iterator3.length)
                            break;
        ...
        PdfImage.prototype.calcViewport = function() {
            ...
            "full" !== this.type && ("right" === this.type && (this.viewport.offsetX += .5 * this.viewport.width,
            this.viewport.transform[4] -= .5 * this.viewport.width),
    ...
    var _libs = __webpack_require__(0)
      , Search = function() {
        ...
        Search.prototype.setResults = function(results, lastPage) {
            this.prevResults.length && results[0] !== this.prevResults[0] && (this.prevResults = [],
            this.results.html(""));
            ...
            (0,
            _libs.$)(htmls.join("")).appendTo(this.results),
    ...
    var _libs = __webpack_require__(0)
      ...
      , StaticImage = function(_ImageBase) {
        function StaticImage(context, width, height, color, src) {
            ...
            ,
            (0,
            _libs.$)(_this.image).on("load", _this.binds.imageLoad).on("error", _this.binds.imageError),
        ...
        StaticImage.prototype.dispose = function() {
            (0,
            _libs.$)(this.image).off("load", this.binds.imageLoad).off("error", this.binds.imageError),
            this.image.src = "",
            delete this.image,
            _ImageBase.prototype.dispose.call(this)
        }
    ...
    var _libs = __webpack_require__(0)
      ...
      , ThreeMouseEventConverter = function(_MouseEventConverter) {
        function ThreeMouseEventConverter(wnd, doc, visualWorld, test) {
            ...
            return _Utils2.default.extends(_this, new _ThreeEventConverter2.default(visualWorld,test)),
            _this
        }
    ...
    var _extends = Object.assign || function(target) {
      ...
      , Thumbnails = function() {
        ...
        Thumbnails.prototype.setImage = function(thumbnail, img) {
            ...
            thumbnail.img = img,
            thumbnail.thumbnail && (thumbnail.thumbnail.css("background-image", ["url('", img, "')"].join("")),
            thumbnail.thumbnail.removeClass("loading")),
            trigger && this.container.trigger("fb3d.thumbnails.thumbnailLoaded", [thumbnail])
        }
        ,
        Thumbnails.prototype.render = function() {
            ...
            for (var items = this.container.find(".item"), base = this.container.find(".thumbnails").offset().top, _i3 = 0; _i3 < items.length; ++_i3) {
                ...
                this.thumbnails[_i3].loaded && this.setImage(this.thumbnails[_i3], this.thumbnails[_i3].img || this.thumbnails[_i3].src);
    ...
    var _libs = __webpack_require__(0)
      ...
      , TouchConverter = function(_EventConverter) {
        function TouchConverter(wnd, doc, element) {
            ...
            (0,
            _libs.$)(_this.element).on("touchstart touchmove", _this.binds.convert),
            (0,
            _libs.$)(_this.doc).on("touchend", _this.binds.convert),
            _this
        }
        return _inherits(TouchConverter, _EventConverter),
        TouchConverter.prototype.dispose = function() {
            (0,
            _libs.$)(this.element).off("touchstart touchmove", this.binds.convert),
            (0,
            _libs.$)(this.doc).off("touchend", this.binds.convert)
        }
        ,
        TouchConverter
    }(_EventConverter3.default);
...
, function(module, exports, __webpack_require__) {
    ...
    exports.__esModule = !0;
    var UserMessageController = (__webpack_require__(0),
    function() {
    ...
    var _extends = Object.assign || function(target) {
      ...
      , View = function() {
        function View(parentContainer, onLoad) {
            ...
            _libs.$)(parentContainer),
            this.isIOS = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream,
            this.isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
            var initUrl = this.isSafari ? ("function" == typeof template ? template() : template).init : void 0;
            ...
            var build = function build() {
                _this3.isIOS && ((0,
                _libs.$)(_this3.parentContainer[0].ownerDocument.defaultView).on("resize", _this3.binds.onResize),
                _this3.onResize(),
                setTimeout(_this3.checkIframeSize.bind(_this3), 250)),
                _this3.container = (0,
                _libs.$)(_this3.frame.contentDocument.body),
                _this3.container.css("margin", "0"),
                _this3.head = (0,
                _libs.$)(_this3.frame.contentDocument.head),
                ...
                var script = template.html ? template.script : _this3.getTemplate().script
                  ...
                  , links = void 0
                  , templateName = void 0;
                "function" == typeof template ? (urls = {},
                files = template(),
                links = [],
                templateName = files.name) : (links = template.links || _this3.getTemplate().links,
                urls = {
                ...
                _this3.loadFiles(urls, files).then(function() {
                    for (var _loop4 = function() {
                        ...
                        (0,
                        _libs.$)('<style type="text/css">' + textCss + "</style>").appendTo(_this3.head);
                    ...
                    for (var _iterator8 = links, _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _iterator8[Symbol.iterator](); ; ) {
                        ...
                        var _link = _ref8;
                        _this3.jLinks.push((0,
                        _libs.$)(["<link ", _this3.objToAttrsStr(_link), ">"].join("")).appendTo(_this3.head))
                    }
                    if (files.script[0]) {
            ...
            initUrl ? (0,
            _libs.$)(this.frame.contentWindow).on("load", build) : (this.frame.contentWindow.stop && this.frame.contentWindow.stop(),
            build())
        }
        ...
        View.prototype.callLater = function(handlers, id, e, data, ms) {
            ...
            setTimeout(function() {
                ...
                pending && timestamp - pending.timestamp >= ms && (View.callHandlers(handlers, id, e, data),
        ...
        View.prototype.urlResolver = function(baseUrl, url) {
            ...
            "/" !== url.charAt(0) && 0 !== url.toLowerCase().search("data:")) {
        ...
        View.prototype.checkIframeSize = function() {
            this.frame && ((Math.abs(this.frame.width - this.parentContainer.width()) > 1 || Math.abs(this.frame.height - this.parentContainer.height()) > 1) && this.onResize(),
        ...
        View.prototype.dispose = function() {
            ...
            this.isIOS && (0,
            _libs.$)(this.parentContainer[0].ownerDocument.defaultView).off("resize", this.binds.onResize),
        ...
        View.setControlState = function(ctrl, defaults, state, stateHandlers) {
            if (ctrl && ctrl[0]) {
                ...
                for (var _name2 in st)
                    st.hasOwnProperty(_name2) && stateHandlers[_name2] && stateHandlers[_name2](ctrl, st[_name2])
            }
        }
        ,
    ...
    var _extends = Object.assign || function(target) {
      ...
      , VisualWorld = function(_THREE$EventDispatche) {
        function VisualWorld(wnd, doc, container) {
            ...
            (0,
            _libs.$)(_this.cssRenderer.domElement).css({
                position: "absolute",
                top: 0,
                margin: 0,
                padding: 0
            ...
            var cssScene = (0,
            _libs.$)(_this.cssRenderer.domElement).find("div")
            ...
            (0,
            _libs.$)(_this.wnd).on("resize", _this.binds.onWindowResize),
            ...
            return _this.mouseEvents.filter = function(element, e) {
                ...
                return "mousemove" === e.type && (filterData.pageX = e.pageX,
        ...
        VisualWorld.prototype.getDiag = function() {
            var test = (0,
            _libs.$)('<div style="height: 1in; width: 1in; display: none;"></div>').appendTo(this.jContainer)
        ...
        VisualWorld.prototype.dispose = function() {
            ...
            (0,
            _libs.$)(this.wnd).off("resize", this.binds.onWindowResize),
        ...
        VisualWorld.getPrecision = function() {
            ...
            t.needsUpdate = !0,
            scene.add(new _libs.THREE.Mesh(new _libs.THREE.PlaneGeometry(1,1,1,1),new _libs.THREE.MeshPhongMaterial({
                map: t
            }))),
            renderer.render(scene, camera);
            var p = function(c, x, y) {
                var ps = new Uint8Array(4);
                return c.readPixels(x, y, 1, 1, c.RGBA, c.UNSIGNED_BYTE, ps),
                ps
        ...
        var f = function() {
            ...
            return u(0),
            {
                ...
                begin: function() {
                    ...
                    if (h.update(c - k, 200),
                    c > g + 1e3 && (r.update(1e3 * a / (c - g), 100),
                    g = c,
                    a = 0,
                    t)) {
    ...
    !function(factory) {
        ...
        function handler(event) {
            ...
            0 !== deltaY || 0 !== deltaX) {
                ...
                (!lowestDelta || absDelta < lowestDelta) && (lowestDelta = absDelta,
